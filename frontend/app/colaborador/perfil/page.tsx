...
export default function ColaboradorPerfilPage() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      setMeta({
        rol: profile.rol || "",
        suscripcion_activa: !!profile.suscripcion_activa,
        auto_aprobado: !!profile.auto_aprobado,
      ...
      <div className="mx-auto max-w-7xl">
        <section className="mb-8 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-[#817d58] md:text-base">
              Administra tu información personal y los datos principales de tu
              cuenta.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8 grid gap-6 xl:grid-cols-[1.05fr_1.4fr]">
              ...
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-[#817d58]">
                    Haz clic en la cámara para cambiar tu imagen, ajustar escala
                    y guardar el recorte.
                  </p>
                </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-[1.6rem] border border-[#817d58]/12 bg-white p-5 shadow-sm">
              <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-2xl bg-[#9f885c]/15">
                <BadgeCheck className="text-[#22341c]" size={20} />
              </div>
              <p className="text-sm text-[#817d58]">Auto aprobación</p>
              <p className="mt-2 text-xl font-bold text-[#22341c]">
                {meta.auto_aprobado ? "Activa" : "Desactivada"}
              </p>
            </div>
            ...
            <div className="rounded-[1.6rem] border border-[#817d58]/12 bg-white p-5 shadow-sm">
              ...
              <p className="text-sm text-[#817d58]">Estado operativo</p>
              <p className="mt-2 text-xl font-bold text-[#22341c]">Activo</p>
            </div>

            <div className="rounded-[1.6rem] border border-[#817d58]/12 bg-white p-5 shadow-sm">
              <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-2xl bg-[#9f885c]/15">
                <Settings className="text-[#22341c]" size={20} />
              </div>
              <p className="text-sm text-[#817d58]">Membresía</p>
              <p className="mt-2 text-xl font-bold text-[#22341c]">
                {meta.suscripcion_activa ? "Activa" : "Pendiente"}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="grid gap-6 xl:grid-cols-[1.3fr_0.9fr]">
          ...
          >
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-[#817d58]">
                Mantén actualizada tu información principal.
              </p>
            </div>
              ...
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#817d58]">
                    Configuración visual preparada para futuras mejoras.
                  </p>
                </div>
              </div>
